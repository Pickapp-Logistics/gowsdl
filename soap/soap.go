...
func (s *Client) CallContext(ctx context.Context, soapAction, xmlns1 string, request, response interface{}) error {
	return s.call(ctx, soapAction, xmlns1, request, response, nil, nil)
}

// Call performs HTTP POST request.
// Note that if the server returns a status code >= 400, a HTTPError will be returned
func (s *Client) Call(soapAction, xmlns1 string, request, response interface{}) error {
	return s.call(context.Background(), soapAction, xmlns1, request, response, nil, nil)
}
...
func (s *Client) CallContextWithAttachmentsAndFaultDetail(ctx context.Context, soapAction, xmlns1 string, request,
	response interface{}, faultDetail FaultError, attachments *[]MIMEMultipartAttachment) error {
	return s.call(ctx, soapAction, xmlns1, request, response, faultDetail, attachments)
}

// CallContextWithFault performs HTTP POST request.
// Note that if SOAP fault is returned, it will be stored in the error.
func (s *Client) CallContextWithFaultDetail(ctx context.Context, soapAction, xmlns1 string, request, response interface{}, faultDetail FaultError) error {
	return s.call(ctx, soapAction, xmlns1, request, response, faultDetail, nil)
}
...
func (s *Client) CallWithFaultDetail(soapAction, xmlns1 string, request, response interface{}, faultDetail FaultError) error {
	return s.call(context.Background(), soapAction, xmlns1, request, response, faultDetail, nil)
}

func (s *Client) call(ctx context.Context, soapAction, xmlns1 string, request, response interface{}, faultDetail FaultError,
